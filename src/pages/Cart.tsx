...
const Cart = () => {
  ...
  const totalCarbonSaved = cartItems.reduce(
    (sum, item) => sum + 2.0 * item.quantity,
    0
  );
      ...
      <div className="min-h-screen bg-cream-50">
        ...
        <div className="container mx-auto px-4 py-16">
          <div className="max-w-2xl mx-auto text-center animate-fade-in">
            ...
            <h1 className="text-3xl font-outfit font-bold text-forest-700 mb-4 animate-scale-in">
              Your Cart is Empty
            </h1>
            <p
              className="text-sage-600 mb-8 animate-fade-in"
            ...
            <Link to="/products">
              <Button
                className="bg-forest-700 hover:bg-forest-800 animate-scale-in hover:scale-110 transition-all duration-300"
      ...
      <div className="container mx-auto px-4 py-8">
        <div className="max-w-6xl mx-auto">
          <h1 className="text-3xl font-outfit font-bold text-forest-700 mb-8 animate-fade-in">
            Shopping Cart
            <span className="ml-4 text-lg text-sage-600">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
              ...
              <div className="bg-white rounded-eco shadow-eco p-6 animate-scale-in">
                  ...
                  {cartItems.map((item, index) => (
                    ...
                    >
                      ...
                      <div className="flex-1">
                        <h3 className="font-semibold text-forest-700 mb-1 hover:text-tree-600 transition-colors">
                          {item.name}
                        </h3>
                        <p className="text-sm text-sage-600 mb-2">
                          Carbon saved: 2.0kg CO₂ per item
                        </p>
                      ...
                      <div className="text-right">
                        <div className="font-semibold text-forest-700 text-lg">
                ...
                <div className="mt-6 pt-6 border-t border-sage-100">
                  <Link to="/products">
                    <Button
                      variant="outline"
                      className="border-sage-300 hover:bg-sage-50 transition-all duration-300 hover:scale-105"
                    >
                      Continue Shopping
                    </Button>
                  </Link>
            ...
            <div className="space-y-6">
              ...
              <div
                className="bg-gradient-to-br from-sage-50 to-tree-50 rounded-eco p-6 animate-scale-in border border-sage-200"
                style={{ animationDelay: "0.2s" }}
              >
                ...
                <div className="text-center">
                  <div className="text-3xl font-bold text-tree-600 animate-pulse">
                  ...
                  <div className="text-xs text-sage-500 mt-2">
                    Equivalent to planting {Math.round(totalCarbonSaved / 4)}{" "}
                    trees 🌳
                  </div>
                </div>
              </div>
              ...
              {/* Order Summary */}
              <div
                className="bg-white rounded-eco shadow-eco p-6 animate-scale-in"
                style={{ animationDelay: "0.4s" }}
              >
