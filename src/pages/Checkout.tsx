  ...
  const handleOrderSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      toast({
        ...
        description: `Order #${order._id.slice(
          -6
    ...
    return (
      <div className="min-h-screen bg-cream-50">
        ...
        <div className="container mx-auto px-4 py-8 pt-24 text-center">
          <h1 className="text-3xl font-outfit font-bold text-forest-700 mb-4">
            Your cart is empty
          </h1>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            ...
            <div className="lg:col-span-2">
              <div className="bg-white rounded-eco shadow-eco p-6">
                <h2 className="text-2xl font-outfit font-bold text-forest-700 mb-6">
                  Order Details
                </h2>
              ...
              <div className="bg-sage-50 rounded-eco p-6">
                ...
                <div className="text-center">
                  <div className="text-2xl font-bold text-sage-700">
                    {(cartItems.length * 1.2).toFixed(1)}kg CO₂
                  </div>
                  <div className="text-sm text-sage-600">
                    Carbon footprint reduced
                  </div>
                  <div className="text-xs text-sage-500 mt-2">
                    🌱 Equivalent to planting {cartItems.length} tree
